...
function NetworkPage() {
  ...
  return (
    <div className="space-y-4">
      <AdminTabs />
      <div>
        <h1 className="text-2xl font-semibold text-slate-50">Network</h1>
        <p className="text-sm text-slate-400">Manage IP pools for macvlan network allocations.</p>
      </div>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-950/60 px-6 py-5">
        ...
        <div className="mt-3 rounded-lg border border-slate-800 bg-slate-900/50 px-4 py-3 text-xs text-slate-300">
          <div className="font-semibold text-slate-100">How this maps to allocations</div>
        ...
        <div className="mt-3 rounded-lg border border-dashed border-slate-800 bg-slate-900/40 px-4 py-3 text-xs text-slate-300">
          <div className="font-semibold text-slate-100">Quick setup</div>
